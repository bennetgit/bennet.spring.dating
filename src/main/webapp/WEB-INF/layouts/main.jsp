...
<%  
request.setAttribute("loginUserInfo", request.getSession().getAttribute("loginUserInfo"));
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <title><decorator:title default="sitemesh2 default title" /> - interracial dating site </title>
        ...
        <div class="ctn-16">
            <div id="header" class="grid-16">
                <div id="header-links">
					...
					<div id="strip">
						<ul>
							<c:if test="${requestScope.loginUserInfo.username != ''}">
								<li class="first"><a
								href="${ctx }/user/${requestScope.loginUserInfo.id }">${requestScope.loginUserInfo.username }</a></li>
							</c:if>
							<li class="first"><a
								href="${ctx }/profile?p=BQD0ZwV0Zt--">My
									Profile</a></li>
							<li><a href="${ctx }/account">My
									Account</a></li>
							<li><a href="${ctx }/contact">Help</a></li>
							<li class="last"><a
            ...
            <div id="navigation" class="grid-16">
				...
				<div class="nav">
					<ul>
						...
						<li><a href="${ctx }/search">Search</a></li>
						<li><a href="${ctx }/inbox">Inbox</a></li>
						<li><a
							href="${ctx }">Favourites</a></li>
						<li class="last"><a
							href="${ctx }">Views</a></li>
					</ul>
				</div>
    ...
    <div class="wrapper" id="footer-ctn">
        <div class="ctn-16">
            <div class="grid-16" id="footer">
            	<ul class="footer-nav">
                    <li><a href="${ctx }/">My Home</a></li>
                    <li><a href="${ctx }/account">My Account</a></li>
                    <li><a href="${ctx }/profile">My Profile</a></li>
                    <li><a href="${ctx }/account?tab=blocked">Blocked</a></li>
                    <li><a href="${ctx }/inbox">Inbox</a></li>
                    <li><a href="${ctx }/inbox?rand=1259364498#favorites-favoritedme-all">Favorites</a></li>
                    <li class="last"><a href="${ctx }/inbox?rand=1224600497#views-viewedme-all">Views</a></li>
                </ul>
                <ul class="footer-nav">
                    <li><a href="${ctx }/interracial-couples">Success Stories</a></li>
                    <li><a href="${ctx }/guarantee">Guarantee</a></li>
